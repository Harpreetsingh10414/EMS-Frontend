export default function AllLeaves() {
  ...
  const allLeaves = [
    { name: "Alice", from: "2025-05-15", to: "2025-05-16", type: "Casual Leave" },
    { name: "Bob", from: today, to: today, type: "Sick Leave" },
  ];

  const todayLeaves = allLeaves.filter((leave) =>
    leave.from <= today && leave.to >= today
  );
  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 p-4 bg-white rounded-xl shadow-lg">
      <h2 className="text-2xl font-semibold text-center mb-4">Manager Dashboard</h2>
